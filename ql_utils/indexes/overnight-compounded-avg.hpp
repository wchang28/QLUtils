...
namespace QuantLib {
    ...
    public:
        OvernightCompoundedAverageInArrearsIndex(
            ...
            const Calendar& fixingCalendar = Calendar(),    // fixing calendar of the index
            ...
            (
                ...
                (fixingCalendar == Calendar() ? OvernightIndex{}.fixingCalendar() : fixingCalendar),	// fixingCalendar
